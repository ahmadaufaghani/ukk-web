        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <div>
                        <h6 class="text-bold">Tambah Buku</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
              <form action="/buku/simpan" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control @error('pengarang') is-invalid @enderror" name="pengarang" placeholder="Silahkan isi pengarang">
                @error('pengarang')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
                ...
                <input type="text" class="form-control @error('penerbit') is-invalid @enderror" name="penerbit" placeholder="Silahkan isi penerbit">
                @error('penerbit')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
                ...
                <input type="number" class="form-control @error('stok') is-invalid @enderror" name="stok" placeholder="Silahkan isi stok">
                @error('stok')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
